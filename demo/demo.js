const steps = [
  ...
  },
  {
    ...
    code: `const parameters = new SRPParameters();
...
const saltAndVerifier = await createVerifierAndSalt(
  ...
  },
  {
    ...
    code: `// save by id (username): salt (s), verifier (v)
...
const serverStep1 = await server.step1(username, s, v);`,
  ...
  },
  {
    ...
    code: `const M2 = await serverStep1.step2(A, M1);
// client has logged in without sending password`,
  ...
  },
  {
    ...
    code: `const step3 = await step2.step3(M2);
